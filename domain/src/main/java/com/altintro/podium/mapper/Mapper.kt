...
object Mapper {
    ...
    fun mapUserEntityToUser(it: UserEntity): User {
        ...
        return User(
                ...
                email = "", //TODO Check email with backend
                interests = mapEntityToSports(it.interests),
                gamesPlayed = Games(ArrayList<Game>()),
                gamesPlaying = mapEntityToGames(it.gamesPlaying),
                gamesUpcoming = Games(ArrayList<Game>()),
                gamesWon = Games(ArrayList<Game>()),               //TODO: Get real amount of games won
